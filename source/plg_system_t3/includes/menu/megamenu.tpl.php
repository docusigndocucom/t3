	...
	static function item($vars)
	{
		...
		if ($item->menu_image) {
			$item->params->get('menu_text', 1) ?
				$vars['linktype'] = '<img class="' . $item->params->get('menu_image_css', '') . '" src="' . $item->menu_image . '" alt="' . $item->title . '" /><span class="image-title">' . $item->title . '</span> ' :
				$vars['linktype'] = '<img class="' . $item->params->get('menu_image_css', '') . '" src="' . $item->menu_image . '" alt="' . $item->title . '" />';
		} else {
